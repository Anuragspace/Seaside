...
export default function SignUpForm() {
  ...
  const handleOAuth2SignUp = async (provider: 'google' | 'github') => {
    try {
      ...
      setAuthError(
        error.message || `An error occurred during ${provider} sign up. Please try again.`
      );
    } finally {
      ...
      <CardBody className="py-4 px-4 sm:py-6 sm:px-6">
        ...
        <div className="space-y-2 sm:space-y-3 mb-4 sm:mb-6">
          <Button
            ...
            variant="bordered"
            className="w-full"
            onPress={() => handleOAuth2SignUp('google')}
          ...
          <Button
            ...
            variant="bordered"
            className="w-full"
            onPress={() => handleOAuth2SignUp('github')}
            isDisabled={isLoading || isSubmitting || oauthLoading !== null}
        ...
        <div className="relative mb-6">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-2 bg-default-50 text-default-500">Or continue with email</span>
          </div>
        </div>
